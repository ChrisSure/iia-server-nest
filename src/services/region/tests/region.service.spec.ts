...
describe('RegionService', () => {
  ...
  it('getRegions', async () => {
    ...
    expect(response[0].point).toEqual(80);
    ...
    expect(response[23].point).toEqual(25);
  });
