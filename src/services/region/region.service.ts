...
export class RegionService {
  ...
  async getRegionsLibrary(): Promise<Array<RegionBase>> {
    return [
      ...
      { id: 20, name: 'Херсонська область', point: 5 },
      { id: 21, name: 'Хмельницька область', point: 65 },
      { id: 22, name: 'Черкаська область', point: 15 },
      { id: 23, name: 'Чернівецька область', point: 90 },
      { id: 24, name: 'Чернігівська область', point: 15 },
    ];
  }
}
